...
export default function LandingPage() {
  ...
  return (
    <main className="relative overflow-hidden pt-6 sm:pt-12 pb-16 sm:pb-20">
      ...
      {/* 1. HERO SECTION */}
      <section className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-4 sm:pt-6 pb-14 sm:pb-20 text-center">
        {/* Top Floating Badge */}
        <div className="inline-flex items-center gap-2 px-3.5 py-1.5 sm:px-4 sm:py-2 rounded-full bg-emerald-500/10 border border-emerald-500/30 text-[11px] sm:text-xs font-bold text-[#00FFA2] mb-6 sm:mb-8 shadow-lg shadow-emerald-500/10 max-w-full truncate">
          <Sparkles size={14} className="animate-spin text-[#00FFA2] shrink-0" />
          <span className="truncate">NOUVEAU : Moteur Raganork v6.2 avec IA Gemini Pro Intégrée</span>
          <span className="w-1.5 h-1.5 rounded-full bg-[#00FFA2] shrink-0" />
        </div>

        {/* Main Headings */}
        <h1 className="text-3xl xs:text-4xl sm:text-6xl lg:text-7xl font-black text-white tracking-tight max-w-5xl mx-auto leading-[1.15] sm:leading-[1.1] mb-5 sm:mb-6">
        ...
        <p className="text-sm sm:text-lg md:text-xl text-slate-300 max-w-3xl mx-auto mb-8 sm:mb-10 font-normal leading-relaxed px-2">
        ...
        {/* CTA Buttons */}
        <div className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-4 max-w-md mx-auto mb-12 sm:mb-16 w-full">
          <Link
            href="/auth?tab=register"
            className="w-full sm:w-auto px-7 py-3.5 sm:py-4 rounded-2xl btn-myzapp text-xs sm:text-sm font-black flex items-center justify-center gap-2 shadow-2xl shadow-emerald-500/30 group"
          >
          ...
          <Link
            ...
            className="w-full sm:w-auto px-6 py-3.5 sm:py-4 rounded-2xl bg-slate-900/90 hover:bg-slate-800 border border-white/10 text-white text-xs sm:text-sm font-bold flex items-center justify-center gap-2 transition-all"
          >
            <Play size={15} className="text-[#00D06C]" />
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-2.5 sm:gap-4 max-w-4xl mx-auto text-left">
          <div className="glass-card rounded-2xl p-3.5 sm:p-5 border border-white/10">
            <div className="text-xl sm:text-3xl font-black text-[#00FFA2] mb-0.5">99.98%</div>
            <div className="text-xs font-semibold text-slate-300">Sécurité Anti-Ban</div>
            <div className="text-[10px] sm:text-[11px] text-slate-500 mt-0.5">Pauses 15-20 min progressives</div>
          </div>
          <div className="glass-card rounded-2xl p-3.5 sm:p-5 border border-white/10">
            <div className="text-xl sm:text-3xl font-black text-white mb-0.5">0.18s</div>
            <div className="text-xs font-semibold text-slate-300">Réponse Rapide</div>
            <div className="text-[10px] sm:text-[11px] text-slate-500 mt-0.5">Haute disponibilité</div>
          </div>
          <div className="glass-card rounded-2xl p-3.5 sm:p-5 border border-white/10">
            <div className="text-xl sm:text-3xl font-black text-emerald-400 mb-0.5">50+</div>
            <div className="text-xs font-semibold text-slate-300">Commandes & Outils</div>
            <div className="text-[10px] sm:text-[11px] text-slate-500 mt-0.5">AI, Media, Groupes, CRM</div>
          </div>
          <div className="glass-card rounded-2xl p-3.5 sm:p-5 border border-white/10">
            <div className="text-xl sm:text-3xl font-black text-sky-400 mb-0.5">24/7</div>
            <div className="text-xs font-semibold text-slate-300">Disponibilité Totale</div>
            <div className="text-[10px] sm:text-[11px] text-slate-500 mt-0.5">Votre bot veille sans arrêt</div>
          </div>
        </div>
      </section>

      {/* 2. INTERACTIVE LIVE BOT SIMULATOR */}
      <section className="relative z-10 max-w-5xl mx-auto px-3 sm:px-6 lg:px-8 py-10 sm:py-16">
        ...
        {/* Interactive Tabs with touch scroll and DaisyUI */}
        <div className="flex items-center gap-1.5 p-1.5 rounded-2xl bg-slate-900/90 border border-white/10 max-w-xl mx-auto mb-6 overflow-x-auto no-scrollbar">
          <button
            onClick={() => setActiveDemoTab("ai")}
            className={`btn btn-xs sm:btn-sm flex-1 whitespace-nowrap rounded-xl text-xs font-bold transition-all border-none ${
              activeDemoTab === "ai"
                ? "bg-[#00D06C] text-[#060D1F] shadow-lg font-black"
        ...
        <div className="rounded-2xl sm:rounded-3xl bg-[#0F172A] border border-white/10 overflow-hidden shadow-2xl">
          {/* Chat Header */}
          <div className="bg-[#0A1128] px-3.5 sm:px-6 py-3 sm:py-4 border-b border-white/10 flex items-center justify-between">
            <div className="flex items-center gap-2.5 sm:gap-3">
              <div className="relative w-8 h-8 sm:w-10 sm:h-10 rounded-full bg-gradient-to-tr from-emerald-400 to-cyan-400 p-0.5 shrink-0">
                ...
                <span className="absolute bottom-0 right-0 w-2.5 h-2.5 sm:w-3 sm:h-3 rounded-full bg-[#00FFA2] border-2 border-[#0A1128]" />
              </div>
              <div>
                <h4 className="text-xs sm:text-sm font-bold text-white flex items-center gap-1.5">
                  MyZapp AI Assistant
                  <span className="badge badge-xs bg-emerald-500/20 text-[#00FFA2] border-none text-[9px] sm:text-[10px]">BOT</span>
                </h4>
                <p className="text-[10px] sm:text-[11px] text-emerald-400 font-medium">En ligne • Réponse instantanée</p>
              </div>
            </div>
            <div className="text-[11px] text-slate-400 hidden sm:block">Chiffrement de bout en bout</div>
          </div>

          {/* Chat Body */}
          <div className="p-3.5 sm:p-6 space-y-3 sm:space-y-4 bg-[#070E24]/60 min-h-[280px] sm:min-h-[300px] flex flex-col justify-end">
            {activeDemoTab === "ai" && (
              <>
                <div className="flex justify-end">
                  <div className="bg-emerald-600/90 text-white rounded-2xl rounded-tr-none px-3.5 py-2 sm:px-4 sm:py-2.5 max-w-[88%] sm:max-w-sm text-xs font-medium shadow-md">
            ...
            {activeDemoTab === "diffuse" && (
              <>
                <div className="flex justify-end">
                  <div className="bg-emerald-600/90 text-white rounded-2xl rounded-tr-none px-3.5 py-2 sm:px-4 sm:py-2.5 max-w-[85%] sm:max-w-sm text-xs font-medium shadow-md">
                ...
                <div className="flex justify-start items-end gap-2">
                  ...
                  <div className="bg-slate-800/90 border border-white/10 text-slate-100 rounded-2xl rounded-tl-none px-3.5 py-2.5 sm:px-4 sm:py-3 max-w-[88%] sm:max-w-md text-xs leading-relaxed shadow-md">
            ...
            {activeDemoTab === "group" && (
              <>
                <div className="flex justify-end">
                  <div className="bg-rose-500/30 border border-rose-500/40 text-rose-200 rounded-2xl rounded-tr-none px-3.5 py-2 sm:px-4 sm:py-2.5 max-w-[85%] sm:max-w-sm text-xs font-medium">
      ...
      <section id="fonctionnalites" className="relative z-10 max-w-7xl mx-auto px-3 sm:px-6 lg:px-8 py-12 sm:py-20">
        <div className="text-center max-w-3xl mx-auto mb-10 sm:mb-16">
          <span className="text-xs font-black tracking-widest text-[#00D06C] uppercase">Arsenal Complet</span>
          <h2 className="text-2xl sm:text-4xl md:text-5xl font-black text-white mt-2 mb-4">
      ...
      {/* 4. USE CASES SECTION */}
      <section id="cas-dusage" className="relative z-10 max-w-7xl mx-auto px-3 sm:px-6 lg:px-8 py-12 sm:py-20 bg-slate-950/40 rounded-2xl sm:rounded-3xl border border-white/5 my-8 sm:my-12">
        <div className="text-center max-w-3xl mx-auto mb-10 sm:mb-16">
          <span className="text-xs font-black tracking-widest text-[#00FFA2] uppercase">Pour qui est fait MyZapp ?</span>
          <h2 className="text-2xl sm:text-4xl md:text-5xl font-black text-white mt-2 mb-3 sm:mb-4">
      ...
      {/* 5. PRICING SECTION */}
      <section id="tarifs" className="relative z-10 max-w-7xl mx-auto px-3 sm:px-6 lg:px-8 py-12 sm:py-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8 max-w-6xl mx-auto items-stretch">
          {/* Plan 1: Starter */}
          <div className="glass-card rounded-2xl sm:rounded-3xl p-6 sm:p-8 border border-white/10 flex flex-col justify-between">
            <div>
              <div className="text-xs font-bold uppercase tracking-wider text-slate-400 mb-2">Starter</div>
              <div className="flex items-baseline gap-1 mb-4">
                <span className="text-3xl sm:text-4xl font-black text-white">0 FCFA</span>
              ...
              <ul className="space-y-3 text-xs text-slate-300 mb-8">
                <li className="flex items-center gap-2">
                  <CheckCircle2 size={15} className="text-[#00D06C] shrink-0" />
            ...
            <Link
              href="/auth?tab=register"
              className="btn btn-block py-3 rounded-xl bg-slate-900 hover:bg-slate-800 border border-white/10 text-white font-bold text-xs text-center transition-colors"
            >
          ...
          <div className="glass-card rounded-2xl sm:rounded-3xl p-6 sm:p-8 border-2 border-[#00D06C] relative flex flex-col justify-between shadow-2xl shadow-emerald-500/20">
            ...
            <div>
              ...
              <ul className="space-y-3 text-xs text-slate-200 mb-8">
                <li className="flex items-center gap-2">
                  <CheckCircle2 size={15} className="text-[#00FFA2] shrink-0" />
            ...
            <Link
              href="/auth?tab=register"
              className="btn btn-block py-3 rounded-xl btn-myzapp font-black text-xs text-center shadow-lg"
            >
              Activer le Pack Pro
            </Link>
          </div>
      ...
      <section id="mises-a-jour" className="relative z-10 max-w-5xl mx-auto px-3 sm:px-6 lg:px-8 py-10 sm:py-16">
        <div className="glass-card rounded-2xl sm:rounded-3xl p-5 sm:p-8 border border-white/10">
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 sm:gap-4 mb-6 border-b border-white/10 pb-6">
            <div>
              <span className="text-xs font-bold text-[#00FFA2] uppercase tracking-wider">Changelog & Nouveautés</span>
              <h3 className="text-xl sm:text-2xl font-bold text-white mt-1">Dernières Mises à Jour (v6.2.30)</h3>
            </div>
      ...
      {/* 7. FINAL CTA BANNER */}
      <section className="relative z-10 max-w-7xl mx-auto px-3 sm:px-6 lg:px-8 pt-8 sm:pt-12 pb-12 sm:pb-16">
        <div className="rounded-2xl sm:rounded-3xl bg-gradient-to-r from-[#00A352] to-[#0A1128] border border-emerald-500/30 p-6 sm:p-14 text-center relative overflow-hidden shadow-2xl">
          ...
          <p className="text-xs sm:text-base text-emerald-100 max-w-2xl mx-auto mb-6 sm:mb-8">
            Rejoignez des centaines d'utilisateurs qui automatisent leur business avec MyZapp. Configuration en moins de 2 minutes.
          </p>
          <Link
            href="/auth?tab=register"
            className="inline-flex items-center gap-2 px-7 py-3.5 sm:px-8 sm:py-4 rounded-2xl bg-white text-[#060D1F] hover:bg-slate-100 font-black text-xs sm:text-sm transition-all shadow-xl hover:scale-105"
          >
